<template>
  <div class="menu-bar">
    ...
    <ebook-settingfont></ebook-settingfont>
...
<script>
import EbookSettingfont  from './ebook-setting-font'
import EbookSettingPopup from './ebook-seetting-popup'
import EbookSettingTheme from './ebook-seting-theme'
import EbookSettingProgress from './ebook-setting-progress'
import EbookSlider from './ebook-slider'
